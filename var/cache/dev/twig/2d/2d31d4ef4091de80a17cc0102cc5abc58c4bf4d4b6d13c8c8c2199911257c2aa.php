...
class __TwigTemplate_84a0fa42884f60ad220886dbbd099da43840fc082792d21ea76fa2b03972a0ff extends Template
{
    private $source;
    private $macros = [];
            ...
            <div class=\"row\">
                <div class=\"col-md-6\">
                    <div class=\"contact-us-content p-4\">
                        <h1 class=\"pt-3\">Salut, comment puis-je t'aider?</h1>
                        <p class=\"pt-3 pb-5\"> </div>
                </div>
                <div class=\"col-md-6\">
                    ";
        // line 15
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["messageForm"]) || array_key_exists("messageForm", $context) ? $context["messageForm"] : (function () { throw new RuntimeError('Variable "messageForm" does not exist.', 15, $this->source); })()), 'form');
        echo "
                </div>
            </div>
        </div>
...
{% endblock content %}", "pages/contact.html.twig", "/home/delvauxjulene/projet_dynamqiue/templates/pages/contact.html.twig");
    }
}
